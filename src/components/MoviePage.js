...
class MoviePage extends Component {
  ...
  render() {
    ...
    const title = `${movie.title || "Movies"}`;
        ...
        <div className="moviepage">
          ...
          <div className="backdropbg">
            <img
              ...
              src={
                ...
                (movie.backdrop_path || "/ylEALgMyJu1JLzSQOIaGGNctHS0.jpg")
              }
              alt="no"
            />
          ...
          <div className="playposter">
            <img
              ...
              src={
                ...
                (movie.poster_path || "/AdoSOsacA5MquZruWeBZVgQ7fSm.jpg")
              }
              alt="no"
            />
            ...
            >
              <div className="videocontainer">
                <iframe
                  style={{ height: "90vh", border: "none", zIndex: 3000 }}
                  src={`https://vodlocker.to/embed?t=${
                    movie.title
                  }&y=${year}&poster=0&chromecast=0&trailer=0`}
                  width="100%"
                />
              </div>
              <a
                className="fullscreenbutton button"
                href={`https://vodlocker.to/embed?t=${
                  movie.title
                }&y=${year}&poster=0&chromecast=0&trailer=0`}
              >
                {" "}
          ...
          <ul className="pagedetails">
            ...
            <li className="startmdb">
              <StarRatingComponent
                ...
                editing={false}
                starCount={5}
                value={Math.round((movie.vote_average || 0) / 2)}
              />
            </li>
            <li className="score">
          ...
          {this.state.similar[0] && (
            <div className="moviecontainer">
              <p className="similarheading">SIMILAR</p>
              <MovieArray data={this.state.similar} />
            </div>
          )}
        </div>
      </DocumentTitle>
